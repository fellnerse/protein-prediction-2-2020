...
class LightAttention(PLModel):
    def __init__(
        ...
        super(LightAttention, self).__init__(output_dim)
...
class LightAttentionOnlyMax(PLModel):
    def __init__(
        ...
        super(LightAttentionOnlyMax, self).__init__(output_dim)
        self.embeddings_dim = embeddings_dim
        self.dropout_pct = dropout
...
class BetterAttention(PLModel):
    def __init__(self, embeddings_dim=1024, kernel_size=32, output_dim=1):
        super(BetterAttention, self).__init__(output_dim)
...
class StandardAttention(PLModel):
    def __init__(
        ...
        super(StandardAttention, self).__init__(output_dim)
        self.embeddings_dim = embeddings_dim
        self.dropout_pct = dropout
...
class SelfAttention(PLModel):
    def __init__(self,
        ...
        super(SelfAttention, self).__init__(output_dim)
        self.embeddings_dim = embeddings_dim
